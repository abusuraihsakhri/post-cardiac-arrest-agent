"""
Automated Pytest for post-cardiac-arrest-agent Enrichment Modules.
"""
import sys
...
from enrichment import (
    ...
    QualityEngine,
    LongEngine,
    PostcardiacarrestagentEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = PostcardiacarrestagentEnrichmentSuite()
